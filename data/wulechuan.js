    ...
    从业经历: [
        {
            ...
            岗位职责: [
                {
                    列: [
                        '作为公司第一名正式的网页开发员，接手老旧的项目雏形，并开始彻头彻尾的改造该项目，并长期维护。',
                        '为新的产品线搭建全新的技术框架，从零开始开发，并长期维护。',
                        '为若干重要项目搭建好框架基础，或完成早期版本。再将代码库转交给其他同僚继续开发或维护。',
                        '紧密围绕公司业务，研发或预研专项技术。例如：在网页中借助独立线程的计算，实时稳定的呈现三维点云。又如：在确保高帧率、高分辨率的前提下，在网页中实现快速的图像变换。还有：在网页中实现适时的视频流画面处理，并实时产出全新的视频流（MediaStream）。',
                        '从零开始负责公司官网。含美术设计、交互设计、编码实现。本人还确保官网排版可自适应几乎一切尺寸的屏幕。不过，第一稿如今已被替换，不再面世。',
                        '负责或指导公司一切项目的网页端代码的审查。',
                        '闲时，负责对网页技术组不定期进行若干次技术培训。',
                        '负责整理公司诸项目中的编码成果，形成高度可复用的库，并发布在 npm 上。',
                    ],
                },
            ],
        },
