        ...
        个人简介: [
...

            {
                ...
                列: [
                    {
                        应强调: true,
                        文: '逾 12 年网页应用开发（即 Web 前端开发）经验。有丰富的“工业级”【富客户端】编写经验。',
                        链前文: '例：',
...

            {
                ...
                列: [
                    ...
                    {
                        应强调: true,
                        文: '具备从需求分析、（软件）产品功能设计、（软件）产品界面设计、（软件）产品人机交互设计、（软件）产品代码设计，到（软件）产品构建与部署的全栈能力。',
                    },
                    {
                        应强调: true,
                        文: '注重研发流程的自动化。独立搭建了可应对多产品线、多型号、多商务品牌组合的全自动【软件发行版群】构建工具。为所在团队制定并带头恪守发布规范，特别是持续维护版本发行与演进文档。',
                    },
                    {
                        应强调: true,
            ...
            岗位职责: [
                {
                    列: [
                        ...
                        {
                            应强调: true,
                            文: '设计并维护了完善的自动化工具链，已确保较复杂的产品线的统一发布，半自动部署（面向嵌入式环境的网页应用不必也不可能全自动部署）。另见下文《项目经验》的相关条目。',
                        },
                        {
                            应强调: false,
            ...
            项目简述: [
                {
                    ...
                    列: [
                        ...
                        {
                            应强调: true,
                            文: '设计并维护了完善的自动化工具链，已确保较复杂的产品线的统一发布，半自动部署（面向嵌入式环境的网页应用不必也不可能全自动部署）。须知，产品线中的不同亚型，配置细节可能迥异，且随着项目演进，历史版的服务端程序接口可能变迁。我对网页端的要求时，用唯一的一套代码兼容一切历史版本的服务端程序。为此，我维护了一整套严谨的配置集。',
                        },
                        {
                            应强调: false,
                            文: '负责该项目一切美术设计。',
...

                {
                    ...
                    列: [
                        ...
                        },
                        {
                            ...
                            链: 'https://gitee.com/nanchang-wulechuan/wulechuan-resume/raw/main/demos/xmecamg1-web-ui/new-look/1-002.jpg',
                            链后文: '。',
                        },
                        {
                            应强调: true,
                            // 链: './demos/xmecamg1-web-ui/new-look/1-003.jpg',
                            链: 'https://gitee.com/nanchang-wulechuan/wulechuan-resume/raw/main/demos/xmecamg1-web-ui/new-look/1-003.jpg',
                            链后文: '。',
                        },
                        {
                            应强调: true,
                            // 链: './demos/xmecamg1-web-ui/new-look/1-004.jpg',
                            链: 'https://gitee.com/nanchang-wulechuan/wulechuan-resume/raw/main/demos/xmecamg1-web-ui/new-look/1-004.jpg',
                            链后文: '。',
                        },
                        {
                            应强调: true,
                            // 链: './demos/xmecamg1-web-ui/new-look/1-005.jpg',
                            链: 'https://gitee.com/nanchang-wulechuan/wulechuan-resume/raw/main/demos/xmecamg1-web-ui/new-look/1-005.jpg',
                            链后文: '。',
                        },
                        {
                            应强调: true,
                            // 链: './demos/xmecamg1-web-ui/new-look/1-006.jpg',
                            链: 'https://gitee.com/nanchang-wulechuan/wulechuan-resume/raw/main/demos/xmecamg1-web-ui/new-look/1-006.jpg',
                            链后文: '。',
                        },
                        {
                            应强调: true,
                            // 链: './demos/xmecamg1-web-ui/new-look/1-007.jpg',
                            链: 'https://gitee.com/nanchang-wulechuan/wulechuan-resume/raw/main/demos/xmecamg1-web-ui/new-look/1-007.jpg',
                            链后文: '。',
                        },
                        {
                            应强调: true,
                            // 链: './demos/xmecamg1-web-ui/new-look/1-008.jpg',
                            链: 'https://gitee.com/nanchang-wulechuan/wulechuan-resume/raw/main/demos/xmecamg1-web-ui/new-look/1-008.jpg',
                            链后文: '。',
                        },
                        {
                            应强调: true,
                            // 链: './demos/xmecamg1-web-ui/new-look/1-009.jpg',
                            链: 'https://gitee.com/nanchang-wulechuan/wulechuan-resume/raw/main/demos/xmecamg1-web-ui/new-look/1-009.jpg',
                            链后文: '。',
                        },
                        {
                            应强调: true,
                            // 链: './demos/xmecamg1-web-ui/new-look/1-010.jpg',
                            链: 'https://gitee.com/nanchang-wulechuan/wulechuan-resume/raw/main/demos/xmecamg1-web-ui/new-look/1-010.jpg',
                            链后文: '。',
                        },
                        {
                            应强调: true,
                            // 链: './demos/xmecamg1-web-ui/new-look/1-011.jpg',
                            链: 'https://gitee.com/nanchang-wulechuan/wulechuan-resume/raw/main/demos/xmecamg1-web-ui/new-look/1-011.jpg',
                            链后文: '。',
                        },
                        {
                            应强调: true,
                            // 链: './demos/xmecamg1-web-ui/new-look/2-001.jpg',
                            链: 'https://gitee.com/nanchang-wulechuan/wulechuan-resume/raw/main/demos/xmecamg1-web-ui/new-look/2-001.jpg',
                            链后文: '。',
                        },
                        {
                            应强调: true,
                            // 链: './demos/xmecamg1-web-ui/new-look/2-002.jpg',
                            链: 'https://gitee.com/nanchang-wulechuan/wulechuan-resume/raw/main/demos/xmecamg1-web-ui/new-look/2-002.jpg',
                            链后文: '。',
                        },
                        {
                            应强调: true,
                            // 链: './demos/xmecamg1-web-ui/new-look/2-003.jpg',
                            链: 'https://gitee.com/nanchang-wulechuan/wulechuan-resume/raw/main/demos/xmecamg1-web-ui/new-look/2-003.jpg',
                            链后文: '。',
                        },
                        {
                            应强调: true,
                            // 链: './demos/xmecamg1-web-ui/new-look/2-004.jpg',
                            链: 'https://gitee.com/nanchang-wulechuan/wulechuan-resume/raw/main/demos/xmecamg1-web-ui/new-look/2-004.jpg',
                            链后文: '。',
                        },
                        {
                            应强调: true,
                            // 链: './demos/xmecamg1-web-ui/new-look/2-005.jpg',
                            链: 'https://gitee.com/nanchang-wulechuan/wulechuan-resume/raw/main/demos/xmecamg1-web-ui/new-look/2-005.jpg',
                            链后文: '。',
                        },
                    ],
                },
            ...
            项目简述: [
                {
                    列: [
                        ...
                        {
                            应强调: true,
                            文: '设计并维护了完善的自动化工具链，已确保较复杂的产品线的统一发布，半自动部署（面向嵌入式环境的网页应用不必也不可能全自动部署）。该套系统亚型不多，但产品发布自动化的技术框架与另一项目类同，仅因演进历史较短，维护代价略低。',
                        },
                        {
                            应强调: false,
